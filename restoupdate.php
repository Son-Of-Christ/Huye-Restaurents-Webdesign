...
.formcontainer {
   ...
   $r="SELECT * FROM restolist WHERE CODE='".$id."';";
...
<span>CODE</span>
<input type="text" class="input" name="restid" value="<?php echo $d['CODE'];?>" readonly >
<span>Restaurent Name</span>
<input type="text" class="input" name="restname" value="<?php echo $d['Restaurent_Names'];?>"  >
...
{	
    ...
    $sql="UPDATE restolist SET Restaurent_Names='$name'WHERE  CODE='".$id."'";
